...
/**
 * 
 * Set a new model of feed items, such as when a feed aggregator has collected the latest feed items.
 * This model is staged (not immediately set on the control) to avoid re-rendering before
 * the currently displayed article is faded out. Therefore a smooth transition between
 * the display of feed items is always maintained.
